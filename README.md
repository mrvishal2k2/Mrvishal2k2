...
<!-- Card hosting notes:
     - assets/github-metrics.svg and assets/streak-stats.svg are generated by .github/workflows/metrics.yml
       and committed to this repo, so they are served by GitHub and cannot rate-limit. They replace the
       stats, top-languages and streak cards, all of which died or rate-limited on shared instances.
